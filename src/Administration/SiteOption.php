...
/**
 * Wrapper class for WordPress site options
 */
class SiteOption {
	/**
	 * Name of the option
	...
	/**
	 * Adds a new site option.
	 *
	 * @param  string|bool $autoload   Do you want the options on page load.
	 * @return bool
	 */
	public function add( $autoload = 'yes' ) {
		return add_site_option( $this->name, $this->value, '', $autoload );
	}

	/**
	 * Gets the site option value from the database.
	 *
	...
	/**
	 * Save the site option in the database
	 *
	 * @param  string|bool $autoload Autload the option on WordPress start-up.
	 * @return bool
	 */
	public function save( $autoload ) {
		return update_site_option( $this->name, $this->value, $autoload );
	}

	/**
	 * Deletes the site option from the database.
	 *
	 * @return bool
	 */
